...
const Hero = () => {
  ...
  return (
    <section className="hero w-section h-screen flex flex-col mt-32 mx-auto">
        ...
        <p className="text-xl text-comment mb-4">As you have read seconds ago, my name is Matteo. I am a highschool <br></br>student who is focusing on learning and improving on programming <br></br>languages, frameworks, and libraries for my future.</p>
        <div className="flex items-center">
          <p className="text-xl text-light-slate">Want to know more? Scroll down!</p>
